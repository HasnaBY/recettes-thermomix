...
const SLOTS = [
  ...
  { key: 'lead_magnet_pdf_background', label: '🎁 Fond décoratif du PDF recette offerte', usage: 'PDF envoyé automatiquement aux prospects — haute résolution' },
]

const HIGH_RES_KEYS = ['menu_pdf_background', 'shopping_list_pdf_background', 'client_menu_pdf_background', 'lead_magnet_pdf_background']
